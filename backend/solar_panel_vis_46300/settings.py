"""
Django settings for solar_panel_vis_46300 project.
...
ROOT_URLCONF = 'solar_panel_vis_46300.urls'
...
WSGI_APPLICATION = 'solar_panel_vis_46300.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solar_panel_vis_46300 API",
    "DESCRIPTION": "API documentation for solar_panel_vis_46300 App",
    "VERSION": "v1",
}
